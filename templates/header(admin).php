            ...
            <div class="hidden md:flex flex-col md:flex-row mt-4 md:mt-0 space-y-4 md:space-y-0 md:space-x-6 justify-center items-center"
                ...
                <div class="relative group">
                    ...
                    <div
                        class="absolute left-0 mt-0 w-48 rounded-md bg-[#26261f] opacity-0 invisible group-hover:opacity-100 group-hover:visible transition duration-300">
                        <div class="py-1 " role="menu" aria-orientation="vertical">
                            <a href="<?php echo BASE_URL; ?>admin/ver-rutina.php"
                                class="block px-4 py-2 text-white hover:bg-[#26261f] rounded-md" role="menuitem">Ver
                                rutinas</a>
                            <a href="<?php echo BASE_URL; ?>admin/procesar-rutinas.php"
                                class="block px-4 py-2 text-white hover:bg-[#26261f] rounded-md" role="menuitem">Agregar
                                rutinas</a>
                        </div>
                    </div>
                </div>
