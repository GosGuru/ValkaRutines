<?php
/*
Template Name: Rutina Miercoles
*/
...
//  obteniendo valores del día lunes
    // Nivel 1 
        ...
        $rutina_lunesNivel1= get_field('nivel_1_miercoles', 'user_' . $user_id);
        $descripcion_lunesNivel1 = get_field('nivel1_miercoles_description', 'user_' . $user_id);
       
    // nivel 2
        $nivel_2_lunes  = get_field('nivel_2_miercoles', 'user_' . $user_id);
        $descripcion_lunesNivel2 = get_field('nivel2_miercoles_description', 'user_' . $user_id);
    // nivel 3 
        $nivel_3_lunes  = get_field('nivel_3_miercoles', 'user_' . $user_id);
        $nivel3_lunes_description= get_field('nivel3_miercoles_description', 'user_' . $user_id);
    // nivel 4
        $nivel_4_lunes  = get_field('nivel_4_miercoles', 'user_' . $user_id);
        $descripcion_lunesNivel4 = get_field('nivel4_miercoles_description', 'user_' . $user_id);
    // nivel 5
        $nivel_5_lunes  = get_field('nivel_5_miercoles', 'user_' . $user_id);
        $descripcion_lunesNivel5 = get_field('nivel5_miercoles_description', 'user_' . $user_id);
    // nivel 6
        $nivel_6_lunes  = get_field('nivel_6_miercoles', 'user_' . $user_id);
        $descripcion_lunesNivel6 = get_field('nivel6_miercoles_description', 'user_' . $user_id);
...
<head>
    ...
    <title>Mi Rutina - Miércoles</title>
    ...
    <main class="container">
        ...
        <div id="week-1" class="content">
            <p>
                ...
                echo '<p><strong>Descripción:</strong> ' . wp_kses_post($descripcion_lunesNivel1) . '</p>';
        ...
        <div id="week-2" class="content">
            ...
            if ($nivel_2_lunes && $descripcion_lunesNivel2) {
                ...
                echo '<p><strong>Descripción:</strong> ' . wp_kses_post($descripcion_lunesNivel2) . '</p>';
        ...
        <div id="week-3" class="content">
            ...
            if ($nivel_3_lunes && $nivel3_lunes_description) {
                   ...
                   echo '<p> ' . wp_kses_post($enlace_nivel_1) . '</p>';
